    ...
    <SafeAreaView className='flex-1' edges={['top']}>
      ...
      <ScrollView className='px-4 flex-1 ' showsVerticalScrollIndicator={false}>
          ...
          BANNERS.map((banner, index)=>(
            ...
            >
              ...
              <View className='absolute bottom-4 left-4 z-10' >
                ...
                <TouchableOpacity className='mt-2 bg-white rounded-full px-4 py-2 self-start'  >
       ...
       <View className='flex-row justify-center mt-3 gap-2'>
         {
          BANNERS.map((_, index)=>(
            <View key={index} className={`h-2 rounded-full ${index === activeBannerIndex ? 'w-6 bg-primary' : 'w-2 bg-gray-200'}  `}
        ...
        {/* Newsletter */}
        <View className='mb-20 bg-gray-100 p-6 rounded-2xl items-center'>
          <Text className='text-2xl mb-2 text-center font-bold text-primary'>Join the revolution</Text>
          <Text className='text-center font-bold text-secondary mb-4'>Subscribe to our newsletter and get 10% off your first purchase.</Text>
          <TouchableOpacity className='w-4/5 bg-primary items-center rounded-full py-3'>
